...
(function () {
  const STRINGS = {
    ar: {
      ...
      attachFiles: 'إرفاق صورة أو ملف',
      attachImageOption: '🖼️ اختيار صورة',
      attachPdfOption: '📄 اختيار ملف PDF',
      attachCodeOption: '📃 اختيار ملف كود',
      removeImage: 'إزالة هذه الصورة',
      removeFile: 'إزالة هذا الملف',
      dropHint: 'أفلت الصور أو الملفات هنا لإرفاقها',
      maxImages: 'يمكنك إرفاق حتى {n} صور في الرسالة الواحدة.',
      maxDocs: 'يمكنك إرفاق حتى {n} ملفات PDF في الرسالة الواحدة.',
      maxFiles: 'يمكنك إرفاق حتى {n} ملفات في الرسالة الواحدة.',
      pdfTooLarge: 'ملف PDF كبير جداً (الحد الأقصى {n} ميغابايت).',
      fileTooLarge: 'الملف كبير جداً (الحد الأقصى {n} ميغابايت).',
      copy: 'نسخ',
      copied: 'نُسخ!',
    ...
    en: {
      ...
      attachFiles: 'Attach an image or file',
      attachImageOption: '🖼️ Choose image',
      attachPdfOption: '📄 Choose PDF',
      attachCodeOption: '📃 Choose code file',
      removeImage: 'Remove this image',
      removeFile: 'Remove this file',
      dropHint: 'Drop images or files to attach them',
      maxImages: 'You can attach up to {n} images per message.',
      maxDocs: 'You can attach up to {n} PDFs per message.',
      maxFiles: 'You can attach up to {n} files per message.',
      pdfTooLarge: 'That PDF is too large (max {n} MB).',
      fileTooLarge: 'That file is too large (max {n} MB).',
      copy: 'Copy',
      copied: 'Copied!',
